...
Расшифрованный текст показывается человеку **до** разбора — требование
`PLAN.md`: «так видно, что именно бот услышал, и ошибка распознавания не
превращается молча в неправильную задачу».
"""
